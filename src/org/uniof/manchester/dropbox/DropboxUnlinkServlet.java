...
/**
 * Servlet implementation class DropboxUnlinkServlet
 */
@WebServlet("/dropbox-unlink")
public class DropboxUnlinkServlet extends HttpServlet {
     ...
     */
    public DropboxUnlinkServlet() throws IOException, DatabaseException {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LLego al unlink la cuenta");
