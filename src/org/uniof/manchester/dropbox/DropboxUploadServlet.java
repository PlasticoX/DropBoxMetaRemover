...
/**
 * Servlet implementation class DropboxUploadServlet
 */
@WebServlet("/upload")
@MultipartConfig(fileSizeThreshold=1024*1024*10, 	// 10 MB 
maxFileSize=1024*1024*50,      	// 50 MB
maxRequestSize=1024*1024*100)   	// 100 MB
public class DropboxUploadServlet extends HttpServlet {
     ...
     */
    public DropboxUploadServlet() throws IOException, DatabaseException {
