...
public class DropboxBrowse
{
        ...
        throws IOException
    {
        ...
        // Upload form
        out.println("<form action='/DropBoxMetaRemover/upload' method='post' enctype='multipart/form-data'>");
        ...
        for (Metadata child : children.values()) {
            String href = "/DropBoxMetaRemover/browse?path=" + DbxRequestUtil.encodeUrlParam(child.getPathLower());
